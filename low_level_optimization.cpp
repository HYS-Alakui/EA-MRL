...
//#include <algorithm>
//
//void QPacking::low_level_optimization(vector<CIndividual>& v_new_TotalChromo_temp, vector <vector<CIndividual>>& v_new_Chromo_temp, vector<Item>& v_product)
//{
//	//下层迭代优化
//	inter_iteration_count = 0;
...
//			//system("pause");
//			
//			////Step2:利用遗传操作，获得当代子种群的新子种群，进而组合为下层优化的Qt种群
...
//				//system("pause");
//				
//				////Step2.1：首先,利用二元锦标赛选择法从当前子种群中选择一个父代，另一个父代随机从精英集中选择			
//				CIndividual lower_fathIndiv, lower_mothIndiv, lower_chIndiv1, lower_chIndiv2;
//				lower_select(lower_fathIndiv, v_new_Chromo_temp[i]);
//				//cout << "选中的父代1：" << endl;
//				//for (int u = 0; u < number_of_jobs * number_of_operations; u++)
//				//{
...
//				else
//				{
//					lower_select(lower_mothIndiv, v_new_Chromo_temp[i]);
//				}
//				//cout << "选中的父代2：" << endl;
//				//for (int u = 0; u < number_of_jobs * number_of_operations; u++)
//				//{
...
//				//system("pause");
//
//				////Step2.2：其次，调用交叉函数对这两个父代的下层变量即v_chromosome2进行交叉，得到两个新的子代下层向量
//				lower_crossover(lower_fathIndiv, lower_mothIndiv, lower_chIndiv1,lower_chIndiv2);
//				//system("pause");
//
//				////Step2.3：接着，调用变异函数对随机一个子代下层向量进行变异
...
//				//system("pause");
//
//				//Step2.4：最后，评估获得的新子代个体并存入子代种群中
//				upper_evaluate(C1, board_width, board_height, v_product);//求上层和下层目标函数值：先求下层目标值，然后基于下层约束求解上层目标值		
//				v_low_subChromo.push_back(C1);
//				v_low_TotalChromo.push_back(C1);
//				//system("pause");
//			}
//			v_low_Chromo.push_back(v_low_subChromo);
//		}
//
//		////Step3:获得Qt种群的上下层序值和拥挤度距离
...
//		//system("pause");
//
//		////Step4:合并Pt(v_new_TotalChromo_temp,v_new_Chromo_temp)和Qt(v_low_TotalChromo,v_low_Chromo)为Rt
...
//		}
//
//		////Step5:获得Rt种群的上层序值和拥挤度距离值，并获得Rt中各个子种群的下层序值和拥挤度距离值
...
//		//system("pause");
//
//		////Step7:v_new_Chromo_temp继承下一代种群v_next_Chromo的染色体基因，重新编号、求解、计算序值和拥挤度距离，同时更新v_new_TotalChromo_temp
